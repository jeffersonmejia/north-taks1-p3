...
-- Keep the order sequence ready for new purchases after loading Northwind data.
SELECT setval(
    'orders_order_id_seq',
...
-- Academic seed helpers for NorthwindStore.
INSERT INTO customers (customer_id, company_name, contact_name, contact_title, city, country, is_deleted)
VALUES ('WEB01', 'Northwind Web Customer', 'Demo Customer', 'Buyer', 'Quito', 'Ecuador', false)
ON CONFLICT (customer_id) DO NOTHING;

UPDATE products
SET units_in_stock = 25, discontinued = false
WHERE product_id IN (1, 2, 3) AND COALESCE(units_in_stock, 0) = 0;
